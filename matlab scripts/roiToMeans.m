...
columnNames = ["Case", "Run", "Sex", "toggleChannel"];
columnNames = [columnNames, imageColumnNames];
columnTypes = ["double", "double", "categorical", "double", repmat("cell", 1, length(imageColumnNames))]; %predefine column names and types
...
columnNames = ["sample", "Sex", "LT1mean", "LT2mean", "LT3mean", "LT1med", "LT2med", "LT3med", "I1mean", "I2mean", "I3mean", "I1med", "I2med", "I3med", "IR13mean", "IR23mean"];
columnTypes = ["double", "categorical", repmat("double", 1, length(columnNames)-2)]; %predefine column names and types
...
writetable(summaryTable, "roiSummaryTable.csv");
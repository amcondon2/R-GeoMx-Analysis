...
flimParamsRaw <- subset(joined, select = c(LT1mean, LT2mean, LT3mean, IR13mean, IR23mean))
splsResult <- spls(countsMatrix, flimParamsRaw, mode = "canonical", scale = TRUE, ncomp = 5)
```
our problem is one of 'feature selection'
  -we should prefer a 'canonical' approach because we expect a reciprocal relationship between sets (transcripts -> fluorophores <- LT measurment) ?? https://bmcbioinformatics.biomedcentral.com/articles/10.1186/1471-2105-10-34

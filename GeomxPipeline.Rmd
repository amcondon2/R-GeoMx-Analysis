...
-- phenoDataDccColName must contain names matching names of DCC files. This info is found in the "LabWorkesheet" Excel file, which I transferred into the AnnotationsDCC file -- columns NOT included in the 'protocolDataColNames' is included in the phenotype data section
...
panCkPosDataSet <- target_dataSet[, pData(target_dataSet)$Segment == "PanCK+"]
